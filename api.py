...
folders = [
    ...
    app.config['UPLOAD_FOLDER2'],
    app.config['UPLOAD_FOLDER3']
]
...
def dbConnection():
    try:
        connection = pymysql.connect(host="localhost", user="root", password="root", database="042-attendence", charset="utf8")
        return connection
    except:
